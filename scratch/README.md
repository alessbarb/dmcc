# Zona Scratch (`scratch/`)

Esta carpeta está reservada exclusivamente para **experimentos locales efímeros, pruebas de concepto y scripts temporales de depuración**.
