                ...
                {jobs.map((j) => (
                  <tr key={j.jobId} style={{ borderBottom: "1px solid var(--border)" }}>
                    ...
                    <td style={{ padding: "16px" }}>
                      ...
                      <div style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginTop: "2px" }}>Campaign: {j.campaignId}</div>
                    </td>
                    <td style={{ padding: "16px" }}>
                      <div style={{ textTransform: "capitalize" }}>{j.actorType}</div>
                      <div style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginTop: "2px" }}>Reason: {j.reason.replace("_", " ")}</div>
                    </td>
                    <td style={{ padding: "16px" }}>
                      {j.attemptCount} / 5
                    </td>
                    ...
                    {status === "failed" && (
                      <td style={{ padding: "16px", maxWidth: "300px" }}>
                        ...
                        <div style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginTop: "2px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }} title={j.lastErrorMessage || ""}>
