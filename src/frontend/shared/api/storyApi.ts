...
export const loadStoryPlan = (campaignId: string) =>
  apiFetch(`/api/campaigns/${campaignId}/story`);

export const createStoryThread = (campaignId: string, payload: { title: string; summary?: string | null; status?: string }) =>
  apiFetch(`/api/campaigns/${campaignId}/story/threads`, { init: jsonInit("POST", payload) });

export const updateStoryThread = (campaignId: string, threadId: string, payload: { title?: string; summary?: string | null; status?: string }) =>
...
export const reconcileStoryStep = (
  campaignId: string,
  stepId: string,
