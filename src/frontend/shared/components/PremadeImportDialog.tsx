...
import type { Campaign, PremadeCampaignTemplate, PremadeCampaignTemplateSummary } from "../stores/campaignStore.js";
...
export function PremadeImportDialog({
  ...
  return (
    <div className="modal-overlay premade-import-dialog-overlay" role="presentation" onClick={(event) => { if (event.target === event.currentTarget && !importing) onClose(); }}>
