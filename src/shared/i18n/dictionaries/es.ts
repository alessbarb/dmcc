...
export const es: TranslationDictionary = {
  ...
  settings: {
    ...
    lanSectionTitle: "Modo Red Local (web sharing)",
    lanModeEnabled: "Modo web sharing Activado",
    lanModeDisabled: "Modo web sharing Desactivado",
    ...
    lanEnabledSuccess: "Modo web sharing activado. Código generado: {code}",
    lanDisabledSuccess: "Modo web sharing desactivado con éxito.",
    lanToggleError: "Error al cambiar el estado de red web sharing.",
    ...
    lanMultiplayerDescription: "Permite que tus jugadores se conecten desde sus propios dispositivos en la misma red Wi-Fi/web sharing para ver el portal.",
    ...
    disableLan: "Desactivar web sharing",
    enableLan: "Activar web sharing",
    uniqueAccessCode: "Código de Acceso (Único)",
    copyCode: "Copiar código",
    serverIp: "Dirección de Red",
    playerShareLink: "Enlace para Compartir con Jugadores",
    copyLink: "Copiar",
    lanInactiveDescription: "El modo web sharing está actualmente inactivo. Actívalo para que tus jugadores puedan conectarse y registrar sus perfiles.",
  },
  canvas: {
    toolbar: {
  ...
  dmLogin: {
    ...
    lanWarning: "El modo web sharing está activado — algunas campañas pueden estar visibles en la red local",
  },
  forgotPassword: {
  ...
  timeline: {
    ...
    descriptions: {
      ...
      settingsUpdated: "Ajustes actualizados (web sharing: {state}).",
