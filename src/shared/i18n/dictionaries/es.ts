...
export const es: TranslationDictionary = {
  ...
  settings: {
    ...
    networkSectionTitle: "Modo Red Local (web sharing)",
    networkModeEnabled: "Modo web sharing Activado",
    networkModeDisabled: "Modo web sharing Desactivado",
    ...
    networkEnabledSuccess: "Modo web sharing activado. Código generado: {code}",
    networkDisabledSuccess: "Modo web sharing desactivado con éxito.",
    networkToggleError: "Error al cambiar el estado de red web sharing.",
    ...
    networkMultiplayerDescription: "Permite que tus jugadores se conecten desde sus propios dispositivos en la misma red Wi-Fi/web sharing para ver el portal.",
    networkAlwaysActiveDescription: "Los jugadores se conectan con enlaces de invitación personales — sin código compartido. Siempre activo en tu red local.",
    ...
    copyLink: "Copiar",
    networkInactiveDescription: "El modo web sharing está actualmente inactivo. Actívalo para que tus jugadores puedan conectarse y registrar sus perfiles.",
  },
  canvas: {
    toolbar: {
  ...
  dmLogin: {
    ...
    networkWarning: "El modo web sharing está activado — algunas campañas pueden estar visibles en la red local",
  },
  forgotPassword: {
