...
export const es: TranslationDictionary = {
  ...
  dmSetup: {
    ...
    addExistingOpenHint: "Cada DM puede crear su propio acceso. Este nuevo DM empezará con sus propias campañas y no verá campañas de otros directores salvo que se compartan más adelante.",
    addExistingBlockedSubtitle: "Inicia sesión con un DM existente antes de crear otro acceso",
    addExistingBlockedHint: "Por seguridad, solo un DM autenticado puede añadir más cuentas de DM a este vault local.",
  ...
  dmUnlock: {
    ...
    lanWarning: "El modo LAN está activado — algunas campañas pueden estar visibles en la red local",
  },
  playerJoin: {
  ...
  guidedStart: {
    ...
    steps: {
      ...
      session: { title: "Primera sesión", description: "Un plan ligero para la próxima mesa: apertura, escenas, pistas, decisiones y cierre.", action: "Preparar sesión" },
    ...
    premiseModal: {
      ...
      description: "Escribe la frase corta que leerías antes de preparar la mesa. Puede describir la situación, el tono, la promesa o el conflicto. Podrás cambiarla más adelante.",
    ...
    helpModal: {
      ...
      description: "Escoge una acción pequeña. DMCC abrirá la plantilla adecuada o creará una preparación de sesión limpia que podrás editar antes de usarla en mesa.",
    },
    recipes: {
      ...
      session: {
        ...
        goal2: "Poner al menos una decisión significativa delante de los jugadores.",
  ...
  campaignTour: {
    ...
    steps: {
      ...
      settings: {
        ...
        body: "En ajustes gestionas la administración de la campaña: idioma, acceso en red local, copias de seguridad, exportación JSON, exportación Markdown y otras opciones del sistema.",
        detail: "DMCC es local-first, así que las copias y exportaciones forman parte del flujo normal. Úsalas antes de cambios grandes, antes de probar algo arriesgado o cuando quieras un archivo legible fuera de la app.",
  ...
  account: {
    ...
    security: {
      ...
      subtitle: "Las contraseñas y códigos de recuperación se gestionan de forma segura para este vault local.",
