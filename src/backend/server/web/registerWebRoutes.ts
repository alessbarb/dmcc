...
import { registerAccountDeletionGuard } from "./accountDeletionGuard.js";
...
import { registerPlayerCharacterSheetWebRoutes } from "./routes/playerCharacterSheetWebRoutes.js";
...
export function registerWebRoutes(server: FastifyInstance, options: WebRoutesOptions): void {
  ...
  void registerPlayerCharacterSheetWebRoutes(server);
