...
| `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css` | feature | entities | 145 | 15 | 1 |
...
| `src/frontend/dm/onboarding/campaign-guided-tour/campaign-guided-tour-layout.css` | feature | onboarding | 89 | 10 | 1 |
...
| `src/frontend/dm/pages/template-entity-preview-modal.css` | feature | pages | 128 | 19 | 1 |
...
| `src/frontend/dm/sessions/session-story-steps.css` | feature | sessions | 154 | 24 | 1 |
| `src/frontend/dm/sessions/session-workspace.css` | feature | sessions | 22 | 3 | 4 |
| `src/frontend/dm/sessions/story-threads-panel.css` | feature | sessions | 145 | 21 | 1 |
...
| `src/frontend/shared/components/watermark.css` | component | shared-components | 39 | 4 | 1 |
...
| `src/frontend/shared/styles/features/auth.css` | feature | shared | 234 | 26 | 3 |
...
| `src/frontend/shared/styles/features/campaign-template/template-import-dialog.css` | feature | shared | 90 | 11 | 1 |
...
| `src/frontend/shared/styles/features/campaign-template/template-preview-editorial-blocks.css` | feature | shared | 142 | 20 | 1 |
| `src/frontend/shared/styles/features/campaign-template/template-preview-editorial.css` | feature | shared | 101 | 17 | 1 |
| `src/frontend/shared/styles/features/campaign-template/template-preview-gated-overlay.css` | feature | shared | 44 | 4 | 1 |
| `src/frontend/shared/styles/features/campaign-template/template-preview-hero.css` | feature | shared | 98 | 13 | 1 |
| `src/frontend/shared/styles/features/campaign-template/template-preview-landing-theme.css` | feature | shared | 139 | 10 | 1 |
| `src/frontend/shared/styles/features/campaign-template/template-preview-layouts.css` | feature | shared | 207 | 30 | 1 |
| `src/frontend/shared/styles/features/campaign-template/template-preview-lists.css` | feature | shared | 89 | 15 | 1 |
| `src/frontend/shared/styles/features/campaign-template/template-preview-meta.css` | feature | shared | 70 | 8 | 1 |
| `src/frontend/shared/styles/features/campaign-template/template-preview-secrets.css` | feature | shared | 90 | 12 | 1 |
| `src/frontend/shared/styles/features/campaign-template.css` | feature | shared | 15 | 0 | 2 |
...
| `src/frontend/shared/styles/features/canvas-entity-node.css` | feature | shared | 131 | 23 | 2 |
...
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-activity.css` | feature | shared | 108 | 14 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-board.css` | feature | shared | 96 | 78 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-campaign-cards.css` | feature | shared | 259 | 48 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-campaign-layout.css` | feature | shared | 260 | 34 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-detail-sheet.css` | feature | shared | 3 | 8 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-dialogs.css` | feature | shared | 66 | 28 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-hero.css` | feature | shared | 149 | 18 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-mobile-dashboard.css` | feature | shared | 8 | 14 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-portal-topbar.css` | feature | shared | 86 | 11 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-quick-actions.css` | feature | shared | 13 | 13 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-responsive-details.css` | feature | shared | 60 | 13 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-responsive-shell.css` | feature | shared | 75 | 13 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-responsive-workspaces.css` | feature | shared | 137 | 22 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-shell.css` | feature | shared | 138 | 16 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-summary.css` | feature | shared | 202 | 29 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-template-library.css` | feature | shared | 105 | 22 | 1 |
| `src/frontend/shared/styles/features/dm-hub-dashboard.css` | feature | shared | 17 | 0 | 1 |
...
| `src/frontend/shared/styles/features/markdown-content.css` | feature | shared | 85 | 16 | 1 |
...
| `src/frontend/shared/styles/features/player-portal/player-history-responsive.css` | feature | shared | 145 | 23 | 1 |
...
| `src/frontend/shared/styles/features/player-portal/portal-form.css` | feature | shared | 76 | 10 | 1 |
| `src/frontend/shared/styles/features/player-portal/portal-transition.css` | feature | shared | 110 | 15 | 1 |
| `src/frontend/shared/styles/features/player-portal.css` | feature | shared | 14 | 0 | 4 |
...
| `src/frontend/shared/styles/layout/campaign-navigation/campaign-navigation-items-states.css` | layout | shared | 142 | 16 | 1 |
| `src/frontend/shared/styles/layout/campaign-navigation/campaign-navigation-items.css` | layout | shared | 4 | 0 | 1 |
...
| `src/frontend/shared/styles/layout/campaign-navigation/campaign-navigation-secondary-layout.css` | layout | shared | 145 | 16 | 1 |
| `src/frontend/shared/styles/layout/campaign-navigation/campaign-navigation-secondary-states.css` | layout | shared | 114 | 12 | 1 |
| `src/frontend/shared/styles/layout/campaign-navigation/campaign-navigation-secondary.css` | layout | shared | 3 | 0 | 1 |
...
| `src/frontend/shared/styles/primitives/ornament.css` | primitive | shared | 385 | 28 | 1 |
...
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:66` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:67` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:71` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:72` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:73` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:75` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:76` | Important declarations bypass the intended cascade. |
...
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:81` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:82` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:83` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:84` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:85` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:97` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:98` | Important declarations bypass the intended cascade. |
...
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:110` | Important declarations bypass the intended cascade. |
...
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:119` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:120` | Important declarations bypass the intended cascade. |
...
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:128` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:133` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:134` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:135` | Important declarations bypass the intended cascade. |
| high | important | `src/frontend/dm/entities/entity-detail-dialog/entity-detail-dialog-foundation.css:144` | Important declarations bypass the intended cascade. |
...
| info | dynamic-style | `src/frontend/dm/hub/CampaignTemplateLibrarySection.tsx:37` | Runtime style requires review and CSS custom-property preference. |
...
| info | dynamic-style | `src/frontend/dm/hub/DmHubCampaignsColumn.tsx:90` | Runtime style requires review and CSS custom-property preference. |
| info | dynamic-style | `src/frontend/dm/hub/DmHubFeaturedCampaign.tsx:20` | Runtime style requires review and CSS custom-property preference. |
...
| info | dynamic-style | `src/frontend/dm/map/network/NetworkInspector.tsx:33` | Runtime style requires review and CSS custom-property preference. |
...
| info | dynamic-style | `src/frontend/dm/map/shared/EntityNodeContent.tsx:69` | Runtime style requires review and CSS custom-property preference. |
...
| critical | mixed-responsibility | `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-board.css:1` | Large stylesheet requires atomization (96 lines, 78 selectors). |
| critical | mixed-responsibility | `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-campaign-cards.css:1` | Large stylesheet requires atomization (259 lines, 48 selectors). |
| high | mixed-responsibility | `src/frontend/shared/styles/features/dm-hub-dashboard/dm-hub-campaign-layout.css:1` | Large stylesheet requires atomization (260 lines, 34 selectors). |
